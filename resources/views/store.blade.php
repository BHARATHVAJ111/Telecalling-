    ...
    <div class="main">
        <div class="row align-items-center">
            ...
            @if (auth()->user()->role_id == 5 || auth()->user()->role_id == 6)
                    <button type="button" class="btn btn-primary dash1 mt-3 text-dark" data-bs-toggle="modal"
                        data-bs-target="#createIndentModal"><i class="fa-solid fa-plus text-light pe-1"></i>Add Parts</button>
                @endif
            </div>
        ...
        <div class="container-fluid">
            <div class="">
                <ul class="d-flex gap-5 bg-second shadow rounded-pill mt-2 pt-3">
                    <p class="nav-item">
                ...
                @foreach ($assets as $key => $values)
                    <tr class="bg-light shadow rounded-circle pb-5">
                        ...
                        <td class="d-flex justify-content-around">
                            ...
                            <a href="{{route('parts.edit',['id'=>$values->id])}}" class="pt-2 ps-2">
