            ...
            <form
                ...
                <div class="">
                    <div class="">
                        ...
                        <div id="open_hour_date" style="display: none;">
                            <label for="">Open Hour:</label><br>
                            <input type="text" id="open_hr" name="open_hr" class="form-control">
                            @error('open_hr')
                            <div class="alert alert-danger">{{ $message }}</div>
                             @enderror
                        ...
                        <div id="closing_hour_date" style="display: none;">
                            <label for="closing_hr">Closing Hour:</label><br>
...
<script>
    $(document).ready(function() {
        $('#movement').change(function() {
            ...
            if (selectedValue === 'Mobilization') {
                $('#open_hour_date').show();
                $('#closing_hour_date').hide();
            } else if (selectedValue === 'De Mobilization') {
                $('#closing_hour_date').show();
                $('#open_hour_date').hide();
