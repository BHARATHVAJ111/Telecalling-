...
<body>
    <div class="container-fluid">
        ...
        <div class="row flex-nowrap">
            <div class="col-auto  bg-white shadow">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('employee.base') }}"
                                class="nav-link align-middle px-0 {{ request()->route()->getName() === 'employee.base' ? 'active' : '' }}">
                                <span class="ms-1 d-none d-sm-inline">
                                    <img src="{{ asset('images/dashboard/suppiliers.png') }}" height="20"
                                        width="20" class="img">
                                    <span class="ms-1"> Assign Base <i class="fas fa-arrow-right"></i></span>
                                </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('Contact.delete') }}"
                                class="nav-link align-middle px-0 {{ request()->route()->getName() === 'Contact.delete' ? 'active' : '' }}">
                                <span class="ms-1 d-none d-sm-inline">
                                    <img src="{{ asset('images/dashboard/suppiliers.png') }}" height="20"
                                        width="20" class="img">
                                    <span class="ms-1"> Delete Base <i class="fas fa-arrow-right"></i></span>
                                </span>
                            </a>
                        </li>
                        <div>
                        <img src="{{ asset('images/dashboard/arrow.png') }}" height="20"
                        width="20" class="img">
                            <a href="#" class=" mb-2 fs-6 btn btn"
