...
@section('content')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between bg-second shadow rounded-pill pt-3 pb-0 mb-4">
                ...
                <p class="nav-item px-4 rounded-pill">
                    <a href=""
                        ...
                        <i class="fa-solid fa-plus text-light"></i>
                            <span class="ms-1 me-1">Add Generator</i></span>
                        </span>
                    </a>
                </p>
            </div>
    ...
    <table class="table table-bordered table-striped table-responsive table-hover mt-5">
        ...
        <tbody>
            @foreach ($generator as $key=> $values)
                <tr class="">
                    <td>{{$key+1}}</td>
                    ...
                    <td class="d-flex gap-3">
                        ...
                        <a href="{{route('generator.edit',['id'=>$values->id])}}" class="pt-2 ms-2">
                        ...
                        @elseif($values->status == 0)
                            <form action="">
                                @csrf
                                <button type="submit" class="btn btn-danger" disabled>Out</button>
                            </form>
                        @endif
                    </td>
                    <td>
