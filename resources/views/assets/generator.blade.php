<div class="container-fluid">
    <form action="{{route('Generator.store')}}" method="POST" id="indentForm" enctype="multipart/form-data">
        @csrf
        <div class="">
            <div class="">
                <div class="row">
                    <div class="col-4">
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('engine_srno') is-invalid @enderror" id="customer_name" name="engine_srno">
                            @error('engine_srno')
                    ...
                    <div class="col-4">
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('dg_range') is-invalid @enderror" id="dg_range" name="dg_range">
                            @error('dg_range')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('engine_make') is-invalid @enderror" id="engine_make" name="engine_make">
                            @error('engine_make')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('battery_make') is-invalid @enderror" id="battery_make" name="battery_make">
                            @error('battery_make')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-4">
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('alternator_make') is-invalid @enderror" id="alternator_make" name="alternator_make">
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('battery_srno') is-invalid @enderror" id="battery_srno" name="battery_srno">
                            @error('battery_srno')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="mt-1">
                            ...
                            <input type="text" class="form-control @error('alternator_srno') is-invalid @enderror" id="alternator_srno" name="alternator_srno">
                    ...
                    <div class="col-3">
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('oil_filter_part') is-invalid @enderror" id="customer_name" name="oil_filter_part">
                    ...
                    <div class="col-3">
                        <div class="form-group mt-1">
                            ...
                            <input type="text" class="form-control @error('diesel_filter_part') is-invalid @enderror" id="diesel_filter_part" name="diesel_filter_part">
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input type="text" class="form-control @error('air_filter_part') is-invalid @enderror" id="air_filter_part" name="air_filter_part">
